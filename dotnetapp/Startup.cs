...
namespace dotnetapp
{
    public class Startup
    {
        ...
        {
            services.AddCors();
services.AddDbContext<yogaTrainerContext>(options => options.UseSqlServer(Configuration.GetConnectionString("myconnstring")));
       services.AddScoped<IUser, User>();
    services.AddScoped<IAuth, Auth>();
   services.AddScoped<IJob,Job>();
    services.AddScoped<IJobSeeker, JobSeeker>();
   services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
                       .AddJwtBearer(options =>
                       {
                           options.TokenValidationParameters = new TokenValidationParameters
                           {
                               ...
                               ValidAudience = Configuration["Jwt:Audeience"],
